    ...
    <nav className=" border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto sm:p-4 p-2">
        <a href='logo' className="flex items-center">
          <img src={logo} className="sm:h-8 h-6 mr-3 rounded-full" alt="Logo" />
          <span className="self-center sm:text-2xl text-lg font-semibold whitespace-nowrap dark:text-white">Phan Huynh</span>
        </a>
